...
derived allele can fail to repreoduce with probability $s\ge0$ (Fig.
...
\begin{figure}[h]
  \centering
  \includegraphics[width=1.0\textwidth]{fig/schematic-AB.pdf}
...
\begin{figure}
  \centering
  \includegraphics[angle=-90,width=0.9\textwidth]{fig/recurrence-selection-dynamic-failures-annotated.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{fig/afs_comp_small_no_jackknife.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.5\textwidth]{fig/schematic-gametes.pdf}
