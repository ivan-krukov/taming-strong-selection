...
draw previously unsampled parents is random, we can first draw a random permutation of the parents, and draw previously unsampled parents in order from this permutation. 
...
Wright-Fisher process to generate $n_o$ offspring required exactly $n_p$ parents and copies exactly $i_o$ derived alleles into the offspring (we call that event that event $\mathcal{S}_{n_o}(i_o, n_p)$).
