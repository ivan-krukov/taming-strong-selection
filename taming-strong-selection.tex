...
we provide some mathematical intuition for the recursion equation with selection, and a more detailed derivation is provided in
...
Once the truncated matrix $\mathbf{Q}_{n_o}$ from Eq. \ref{eq_truncated} is constructed, or 
the jackknife-corrected  $\tilde {\mathbf{Q}}_{n_o},$ they can be
...
(i.e., with $\epsilon = 0$) show moderate departures from the exact results, mostly 
\sgcomment{TBC}

However, the diffusion-based approaches diverge
in several ways.
