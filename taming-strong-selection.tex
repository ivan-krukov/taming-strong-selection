...
in large samples than state of the art diffusion-based \cite{GutenkunstEtAl2009} or recursion-based \cite{JouganousEtAl2017} approaches. 
...
%P(S_i = \omega |S[:i-1]  ) &= \sum_{\sigma(\Omega)[:k_i+1] } P(S_i = \omega |\sigma(\Omega)[:k_i+1] , S[:i-1] ) \\ &~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ P(\sigma(\Omega)_{k_i+1} |\sigma(\Omega)[:k_i] ,  S[:i-1] )\\
%&~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~P(\sigma(\Omega)[:k_i] |S[:i-1] ) \\
%&= \sum_{\{\sigma(\Omega)_j\}_{j=1,\ldots, k_i+1}} P(\sigma(\Omega)_{k_i+1} = \omega |\{\sigma(\Omega)_j\}_{j=1, \ldots, k_i}, \{S_1,\ldots, S_{i-1}\} )\\
%&~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~P(\{\sigma(\Omega)_j\}_{j=1, \ldots, k_i} | \{S_1,\ldots, S_{i-1}\} )  \\
%&= \sum_{\{\sigma(\Omega)_j\}_{j=1,\ldots, k_i}} \frac{1}{|\Omega |} P(\{\sigma(\Omega)_j\}_{j=1, \ldots, k_i} | \{S_1,\ldots, S_{i-1}\} ) \\
%&=\frac{1}{|\Omega |}
\end{split}
\end{equation}
