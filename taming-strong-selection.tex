...
First, recursions are not formally closed under natural selection, meaning that
...
$n_o.$ (see Table \ref{tab_symbols}). This does not hold under negative selection --
...
rapidly with sample size. The jackknife approximation improves the performance further.
