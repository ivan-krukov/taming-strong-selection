...
are related to properties of samples size $n_o-1.$ \sgcomment{Similar recursions on sample size were used, in [[context, I believe small sample size and weak selection?]], in \cite{OneOfYunsPapers}}.
