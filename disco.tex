...
where the proportion $x_p$ of derived alleles in the parental generation is one, we consider the 
...
Arfwedson) distribution \citep{Wakeley2009,ONeill2019,JohnsonEtAl2005}: \sgcomment{I don't think that this is quite
true, since the result will depend on the number of derived alleles. But it will be true if $x_p=1$, so we can rescue by treating it as an approximation otherise}
