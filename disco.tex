...
% Panels A,B,C show the \textit{AFS} under neutrality; D,E,F under strong negative selection
% \sgcomment{This would be in the caption, no?}. Under neutrality, all the models agree, yielding
% similar \textit{AFS}. \sgcomment{That is not my interpretation...}
