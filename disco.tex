...
Since $P_{n_o,n_p}(i,j)$ is a probability distribution over $n_p$ and $i$, we can easily compute the truncated probability as
 $1-\sum_{i=0}^{n_o} \sum{n_p=0}^{n_o}{P_{n_o,n_p}(i,j)}$. 
