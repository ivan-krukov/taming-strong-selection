...
anywhere between $0$, and $r_{max}$ selective re-draw evants. The probability for $r$ re-draws
$T_{r}\Coalc{\cdot}{\cdot}{\cdot}{n_o-1}$ is the sum of terms \textit{rC} and \textit{rD}.
