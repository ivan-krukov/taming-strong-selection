...
calculations. This also allows us to treat the lineages as exchangeable \citep{Wakeley2009}. Note that
...
\citep{KroneNeuhauser1997}, but now includes sample size directly.
...
will be occupied (see \citep{JohnsonEtAl2005} section 10.4 for a thorough treatment). In our case,
...
pre-computing a table of reduced occupancy numbers, using the algorithm of \citep{ONeill2019}.
