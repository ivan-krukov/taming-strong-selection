...
the number of derived alleles $i_p$ among them in the parental generation:
 
 \begin{equation}
 \begin{split}
 P(i_o, n_{pp} | r(i_{pp}, n_{pp})) & = \sum_{i_p,n_p} P(i_o, n_{pp} ; i_p, n_p, r(i_p,n_p)  | q(i_{pp}, n_{pp}))\\
 &= \sum_{i_p,n_p} P(i_o, n_p,  r(i_p,n_p); n_{pp}  | q(i_{pp}, n_{pp}))\\
 &= \sum_{i_p,n_p} P(i_o, n_p|   r(i_p,n_p); n_{pp}  ; q(i_{pp}, n_{pp}))  P(r(i_p,n_p); n_{pp}  | q(i_{pp}, n_{pp}))\\
 &= \sum_{i_p,n_p} P(i_o, n_p |   r(i_p,n_p))  P( r(i_p,n_p); n_{pp}  | q(i_{pp}, n_{pp}))\\
 &= \sum_{i_p,n_p} P(i_o, n_p |   r(i_p,n_p))  P( r(i_p,n_p); n_{pp}  | q(i_{pp}, n_{pp}))
 \end{split}
\end{equation}
