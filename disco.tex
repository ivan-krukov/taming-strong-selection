...
&\equiv    \mathbf{Q}_{n_p,n_o}  \afs{n_o}{t-1}\\ 
\end{split}
\label{eq:truncated}
\end{equation}
...
operations. \sgcomment{We will discuss approximate solutions below? add the number of selection events allowed per ploid?}
