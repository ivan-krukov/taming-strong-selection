...
unaccounted for. Since $\mathbf{Q}_{n_o}(i_p, i_o)$ is a probability distribution over $i_o$ \sgcomment{We have not yet defined $Q$ as a probability distribution}, we can
