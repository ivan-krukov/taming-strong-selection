...
the number of derived alleles $i_c$ among them in the parental generation:
 ...
 &= \sum_{i_c,n_c} P(i, n_c,  r(i_c,n_c); n_g  | q(i_g, n_g))\\
 &= \sum_{i_c,n_c} P(i, n_c|   r(i_c,n_c); n_g  ; q(i_g, n_g))  P(r(i_c,n_c); n_g  | q(i_g, n_g))\\
 &= \sum_{i_c,n_c} P(i, n_c |   r(i_c,n_c))  P( r(i_c,n_c); n_g  | q(i_g, n_g))\\
 &= \sum_{i_c,n_c} P(i, n_c |   r(i_c,n_c))  P( r(i_c,n_c); n_g  | q(i_g, n_g))
 \end{split}
\end{equation}
