...
\begin{table}
  ...
  \begin{tabular}{l|p{100mm}}
    ...
    $C(i_p, n_p)$ & Event of $n_p$ parental lineages \textit{containing} $i_p$ derived alleles \\
    $S(n_p)$ & Event of \textit{stopping} draws after $n_p$ parental lineages \\
    $Q(i_o, n_o, r)$ & Event of $i_o$ of $n_o$ successfully drawn offspring lineages drawn with $r$ selective deaths\\
  \end{tabular}
...
\ref{fig:rec-selection-dynamic-fail}.  \sgcomment{Please check the math on that ! } 
